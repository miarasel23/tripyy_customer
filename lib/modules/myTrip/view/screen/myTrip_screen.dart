...
class MytripScreen extends StatelessWidget {
  ...
  Widget _buildRoundWayTripWidget(AppLocalizations loc, BuildContext context) {
    return Padding(
  ...
  Widget _buildHourlyTripWidget(AppLocalizations loc, BuildContext context) {
    return Padding(
